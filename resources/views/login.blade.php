...
<div class="flex flex-col items-center justify-center min-h-screen">
    <!-- FINAL ITEMS CENTRALIZADO -->

    <!-- Cabeçalho Entrar + Login Google -->
    ...
    <div class="max-w-md m-auto text-center">
      ...
      <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
       Ainda não tem uma conta ?
        <a class="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500" href="/cria-conta">
          Inscreva-se aqui
        </a>
      </p>
    </div>
        ...
        <div class="grid gap-y-4">
          ...
          <div>
            <div class="flex justify-between items-center">
              ...
              <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium" href="../examples/html/recover-account.html">Esqueceu sua senha ?</a>
            </div>
            <div class="relative">
          ...
          <div class="flex items-center">
            ...
            <div class="ms-3">
              <label for="remember-me" class="text-sm dark:text-white">Lembrar senha</label>
            </div>
          </div>
          <!-- End Checkbox -->
